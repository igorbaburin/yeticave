...
<?php else : ?>
    <div class="form__access--denied">
      <img src="/img/blocked.png" alt="no-rights">
      <h3>У вас нет прав для добавления лота!</h3>
      <p>Пожалуйста, выполните <a href="/login.php">вход</a></p>
    </div>
<?php endif; ?>